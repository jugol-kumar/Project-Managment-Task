<template>
    <!-- Root div with click.stop to prevent bubbling -->
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr v-for="(task, index) in tasks" :key="task.id" class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ task.assigned_user }}</td>
...
const tasks = ref([])
const users = ref([]) // Load users to assign
const newTask = ref({
    title: '',
    deadline: '',
    assigned_user: '',
...
const submitTask = async () => {
    ...
    try {
        await axios.post(`/api/projects/${project.id}/tasks`, newTask.value)
